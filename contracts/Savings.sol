...
contract Savings is AutomationCompatible {
    ...
    constructor(ISwapProxy _swapProxy, address _owner, address[] memory _whitelistTokens, TokenDistribution[] memory _tokenDistribution) {
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        if (address(this).balance > 0) {
          for (uint256 x = 0; x < tokenDistribution.length; x++) {
            uint256 amount = balance * tokenDistribution[x].distribution / 100;
